...
For the video script: narrate a guided tour that scrolls down the actual page from top to bottom, pointing at real sections you can see in the screenshot (header, hero, services, footer, etc.) and calling out the problems as you reach them. The "focus" value must correspond to where that section really sits in the screenshot. Spoken narration should sound natural when read aloud by a text-to-speech voice.`;
